...
describe('AuthService', () => {
    ...
    it('should validate user', async () => {
        ...
        await userService.resetPassword('admin', token);
        const result = await authService.validateUser(toBeCreatedUser.userName, 'admin');
    ...
    it('login should work', async () => {
        ...
        const result = await authService.login({ ...inDatabaseCreatedUser, password });
